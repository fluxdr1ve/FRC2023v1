...
public class SimpleDriveDistance extends CommandBase {
  ...
  @Override
  public void execute() {
    double measurement = m_drivetrain.getEncoderMeters();
    ...
    SmartDashboard.putNumber("minEffort",minEffort);
    SmartDashboard.putNumber("direction",direction);
    //feedback: the code should work fine. Just see what its doing in auton
